...
@CucumberOptions (features = "src/test/resources/features/Internexa/Dynamics", tags = {"@CPGEneralSolucionProyectoConFactibilidad300"}, monochrome= true)

@RunWith(RunnerPersonalizado.class)
public class RunnerProycSolFactibilidad300 {
	@BeforeSuite
