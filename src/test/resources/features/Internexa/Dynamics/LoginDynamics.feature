...
Then se presenta la pantalla de Nuevo Oportunidad y se ingresa la cuenta "Avantel S.A." el nombre "PRUEBA Auto1.4" el tipo de venta "Nuevo cliente" fecha estimada de venta "16/02/2018" probabilidad de exito "60%" fecha estimada de ingreso "17/02/2018" tipo de oportunidad "Proyecto" contrato a meses "9" y se guarda la oportunidad
